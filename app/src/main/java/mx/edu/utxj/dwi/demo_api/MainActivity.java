...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "http://10.10.62.18:3300/";
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etCodigoBaras.getText().toString().isEmpty()) {
                    Toast.makeText(MainActivity.this, "Busque el  producto, codigo de Barras!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    JsonObjectRequest actualizar = new JsonObjectRequest(
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        if (response.getString("status").equals("Productos actualizados")) {
